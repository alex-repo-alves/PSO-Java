...
public class Swarm {
    ...
    public Swarm(int numParticles) {
        ...
        for (int i = 0; i < numParticles; i++) {
            if (Math.random() <= 0.5) {
                double[] initialParticlePosition = {random.nextDouble()*Constants.PARTICLE_UPPER_BOUND,
                    random.nextDouble()*Constants.PARTICLE_UPPER_BOUND};
                double[] initialParticleSpeed = {random.nextDouble()*Constants.PARTICLE_UPPER_BOUND,
                    random.nextDouble()*Constants.PARTICLE_UPPER_BOUND};
